...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const [highContrast, setHighContrastState] = useState(defaultTheme.highContrast);
  ...
  useEffect(() => {
    ...
    if (savedTheme) {
      try {
        ...
        setAnimationsState(parsed.animations !== undefined ? parsed.animations : defaultTheme.animations);
  ...
  useEffect(() => {
    ...
    const colorMap = {
      blue: { primary: '#2563eb', primaryHover: '#1d4ed8', primaryLight: '#dbeafe' },
      green: { primary: '#059669', primaryHover: '#047857', primaryLight: '#d1fae5' },
      purple: { primary: '#7c3aed', primaryHover: '#6d28d9', primaryLight: '#e9d5ff' },
      orange: { primary: '#ea580c', primaryHover: '#c2410c', primaryLight: '#fed7aa' },
    };
